...
| `GH_TOKEN`                                             | `scripts/rwx-github-deployment.sh` (GitHub Deployment record)                                                            | n/a                                                                                                                   | **CD:** RWX vault `si_deploy.github-apps.rwx-automation-somewhatintelligent.token` (`deployments: write`)                                                                                                                           |
