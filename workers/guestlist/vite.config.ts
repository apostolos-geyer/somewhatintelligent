...
export default defineConfig({
  ...
  run: {
    tasks: {
      ...
      // (gitignored codegen); the task graph guarantees it exists first.
      // `vp run build` is the bundle-validity gate (wrangler dry-run);
      // deploy paths that bundle should run it.
      build: {
