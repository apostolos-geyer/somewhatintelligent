...
// /__version — answered at the worker boundary (src/index.ts) before Elysia
// routing, in both spellings: direct and through bouncer's /api passthrough
// mount (prefix not stripped). Values are ship-time-injected vars
