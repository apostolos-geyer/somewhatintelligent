/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc` (hash: 5b874258ee14226278172dd3e01ce356)
// Runtime types generated with workerd@1.20260515.1 2026-04-19 nodejs_compat
interface __BaseEnv_Env {
  ENVIRONMENT: "production" | "staging";
  VAULT_ACTIVE_KEK_VERSION: "1";
  VAULT_TENANT: DurableObjectNamespace<import("./src/index").VaultTenantDO>;
  VAULT_RPC:
    | Service /* entrypoint Vault from si-vault-production */
    | Service<typeof import("./src/index").Vault>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/index");
    durableNamespaces: "VaultTenantDO";
  }
  interface ProductionEnv {
    ENVIRONMENT: "production";
    VAULT_ACTIVE_KEK_VERSION: "1";
    VAULT_TENANT: DurableObjectNamespace<import("./src/index").VaultTenantDO>;
    VAULT_RPC: Service /* entrypoint Vault from si-vault-production */;
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "ENVIRONMENT" | "VAULT_ACTIVE_KEK_VERSION">
  > {}
}
declare module "*.sql" {
  const value: string;
