/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./wrangler.jsonc -c ../guestlist/wrangler.jsonc` (hash: e0084f833c472cd89f314e5fc3839dd2)
// Runtime types generated with workerd@1.20260515.1 2026-04-16 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	VECTORIZE: VectorizeIndex;
	AE: AnalyticsEngineDataset;
	SPROUT_JOBS_QUEUE: Queue;
	BROWSER: Fetcher;
	AI: Ai;
	CF_ACCOUNT_ID: "30ce6004cd9c2907f0b06fe401c4f4ba";
	RTK_APP_ID: "aa065fe9-14b0-48dd-851d-dbc1b0a3ca20" | "0c1b7acb-8465-4af0-8069-68245e0bb28e";
	ENVIRONMENT: string;
	SPROUT_URL: string;
	IDENTITY_URL: string;
	AUTH_DOMAIN: string;
	...
	GROUP_CHAT_ROOM: DurableObjectNamespace<import("./src/worker").GroupChatRoom>;
	GUESTLIST: Service<typeof import("../guestlist/src/index").default>;
	ROADIE: Service /* entrypoint Roadie from sprout-roadie-production */ | Service /* entrypoint Roadie from sprout-roadie-staging */;
	PROMOTER: Fetcher /* sprout-promoter-production */ | Fetcher /* sprout-promoter-staging */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "GroupChatRoom";
	}
	interface ProductionEnv {
		...
		GROUP_CHAT_ROOM: DurableObjectNamespace<import("./src/worker").GroupChatRoom>;
		GUESTLIST: Service<typeof import("../guestlist/src/index").default>;
		ROADIE: Service /* entrypoint Roadie from sprout-roadie-production */;
		PROMOTER: Fetcher /* sprout-promoter-production */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCOUNT_ID" | "RTK_APP_ID" | "ENVIRONMENT" | "SPROUT_URL" | "IDENTITY_URL" | "AUTH_DOMAIN" | "BNC_ATT_KID" | "BNC_ATT_PRIV" | "BRAND_RESOLUTION">> {}
}
