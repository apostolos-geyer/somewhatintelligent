/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc` (hash: 599dcfde50376cc38b4be7866a983c42)
// Runtime types generated with workerd@1.20260515.1 2026-04-19 nodejs_compat
interface __BaseEnv_Env {
  ASSETS: Fetcher;
  ENVIRONMENT: string;
  SITE_URL: string;
  PUBLISHER:
    | Service /* entrypoint PublisherPublic from si-publisher-production */
    | Service /* entrypoint PublisherPublic from si-publisher-staging */;
  STORE:
    | Service /* entrypoint StoreCatalog from si-store-production */
    | Service /* entrypoint StoreCatalog from si-store-staging */;
}
declare namespace Cloudflare {
  interface ProductionEnv {
    ...
    ENVIRONMENT: string;
    SITE_URL: string;
    PUBLISHER: Service /* entrypoint PublisherPublic from si-publisher-production */;
    STORE: Service /* entrypoint StoreCatalog from si-store-production */;
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SITE_URL">> {}
}
