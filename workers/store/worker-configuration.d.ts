/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc --config=../guestlist/wrangler.jsonc --config=../roadie/wrangler.jsonc` (hash: 9ff72c209818fc9980c2831f97d547c5)
