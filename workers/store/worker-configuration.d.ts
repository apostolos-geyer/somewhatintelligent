/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc --config=../guestlist/wrangler.jsonc --config=../roadie/wrangler.jsonc` (hash: 34733c6b3f788eddad74aec472b2ae18)
// Runtime types generated with workerd@1.20260714.1 2026-04-16 nodejs_compat
interface __BaseEnv_Env {
  DB: D1Database;
  STRIPE_EVENTS: Queue;
  SITE_URL: "https://somewhatintelligent.ca" | "https://staging.somewhatintelligent.ca";
  STORE_LIVE: "false";
  ENVIRONMENT: string;
  IDENTITY_URL: string;
  AUTH_DOMAIN: string;
...
declare namespace Cloudflare {
  ...
  interface ProductionEnv {
    DB: D1Database;
    STRIPE_EVENTS: Queue;
    SITE_URL: "https://somewhatintelligent.ca";
    STORE_LIVE: "false";
    ENVIRONMENT: string;
    IDENTITY_URL: string;
    AUTH_DOMAIN: string;
