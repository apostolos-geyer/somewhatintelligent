/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 59d888c027c1295a46a52c2d630185c8)
// Runtime types generated with workerd@1.20260714.1 2026-04-19 nodejs_compat
interface __BaseEnv_Env {
  OPERATOR_URL:
    | "https://desk.somewhatintelligent.ca"
    | "https://desk.staging.somewhatintelligent.ca";
  ENVIRONMENT: string;
  DEV_OPERATOR: string;
  STORE:
    | Service /* entrypoint StoreOperator from si-store-production */
    | Service /* entrypoint StoreOperator from si-store-staging */;
  PUBLISHER:
    | Service /* entrypoint PublisherOperator from si-publisher-production */
    | Service /* entrypoint PublisherOperator from si-publisher-staging */;
}
declare namespace Cloudflare {
  ...
  interface ProductionEnv {
    ...
    ENVIRONMENT: string;
    DEV_OPERATOR: string;
    STORE: Service /* entrypoint StoreOperator from si-store-production */;
    PUBLISHER: Service /* entrypoint PublisherOperator from si-publisher-production */;
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "OPERATOR_URL" | "ENVIRONMENT" | "DEV_OPERATOR">
  > {}
}
