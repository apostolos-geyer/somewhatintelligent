/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../guestlist/wrangler.jsonc` (hash: d1943a654be1a567c15a06bd2b3021f3)
...
interface __BaseEnv_Env {
  ROUTES:
    | {
        routes: [
          ...
          { binding: "IDENTITY"; host: "somewhatintelligent.ca"; path: "/account"; mode: "vmf" },
          { binding: "STORE"; host: "somewhatintelligent.ca"; path: "/shop"; mode: "vmf" },
          { host: "somewhatintelligent.ca"; path: "/"; mode: "redirect"; to: "/shop"; status: 308 },
          {
            binding: "GUESTLIST";
          ...
          { binding: "STORE"; host: "www.somewhatintelligent.ca"; path: "/shop"; mode: "vmf" },
          {
            host: "www.somewhatintelligent.ca";
            path: "/";
            mode: "redirect";
    ...
    | {
        routes: [
          ...
          { binding: "STORE"; host: "staging.somewhatintelligent.ca"; path: "/shop"; mode: "vmf" },
          {
            host: "staging.somewhatintelligent.ca";
            path: "/";
            mode: "redirect";
  ...
  IDENTITY: Fetcher /* si-identity-production */ | Fetcher /* si-identity-staging */;
  STORE: Fetcher /* si-store-production */ | Fetcher /* si-store-staging */;
}
declare namespace Cloudflare {
  ...
  interface ProductionEnv {
    ROUTES: {
      routes: [
        { binding: "GUESTLIST"; host: "somewhatintelligent.ca"; path: "/api"; mode: "passthrough" },
        { binding: "IDENTITY"; host: "somewhatintelligent.ca"; path: "/account"; mode: "vmf" },
        { binding: "STORE"; host: "somewhatintelligent.ca"; path: "/shop"; mode: "vmf" },
        { host: "somewhatintelligent.ca"; path: "/"; mode: "redirect"; to: "/shop"; status: 308 },
        {
        ...
        { binding: "IDENTITY"; host: "www.somewhatintelligent.ca"; path: "/account"; mode: "vmf" },
        { binding: "STORE"; host: "www.somewhatintelligent.ca"; path: "/shop"; mode: "vmf" },
        {
          host: "www.somewhatintelligent.ca";
          path: "/";
    ...
    BNC_ATT_PRIV: string;
    GUESTLIST: Service<typeof import("../guestlist/src/index").default>;
    IDENTITY: Fetcher /* si-identity-production */;
    STORE: Fetcher /* si-store-production */;
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "ROUTES" | "ENVIRONMENT" | "IDENTITY_URL" | "BNC_ATT_KID" | "BNC_ATT_PRIV">
  > {}
}
