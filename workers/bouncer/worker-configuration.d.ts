/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../guestlist/wrangler.jsonc` (hash: d5631f044800c21505ea7778eef5511c)
// Runtime types generated with workerd@1.20260515.1 2026-04-14 nodejs_compat
interface __BaseEnv_Env {
  ENVIRONMENT: "production" | "staging";
  IDENTITY_URL:
    | "https://somewhatintelligent.ca/account"
    | "https://staging.somewhatintelligent.ca/account";
  BNC_ATT_KID: "production" | "dev";
  ROUTES:
    | {
        routes: [
          {
  ...
  GUESTLIST: Service<typeof import("../guestlist/src/index").Guestlist>;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "ENVIRONMENT" | "IDENTITY_URL" | "BNC_ATT_KID" | "ROUTES">
  > {}
}
