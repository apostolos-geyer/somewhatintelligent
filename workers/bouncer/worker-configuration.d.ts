/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../guestlist/wrangler.jsonc` (hash: 470b691f97f298bdaa166c1630c9dac6)
// Runtime types generated with workerd@1.20260515.1 2026-04-14 nodejs_compat
interface __BaseEnv_Env {
	SPROUT_URL: "https://sprout.sproutportal.ca" | "https://sprout-staging.sproutportal.ca";
	ROUTES: {"routes":[{"binding":"GUESTLIST","host":"identity.sproutportal.ca","path":"/api","mode":"passthrough"},{"binding":"GUESTLIST","host":"identity.sproutportal.ca","path":"/u","mode":"passthrough"},{"binding":"IDENTITY","host":"identity.sproutportal.ca","path":"/","mode":"passthrough"},{"binding":"MARKETING","host":"sproutportal.ca","path":"/","mode":"passthrough"},{"binding":"MARKETING","host":"www.sproutportal.ca","path":"/","mode":"passthrough"},{"binding":"SPROUT","host":"sproutportal.ca","path":"/hub","mode":"passthrough"}]} | {"routes":[{"binding":"GUESTLIST","host":"identity-staging.sproutportal.ca","path":"/api","mode":"passthrough"},{"binding":"GUESTLIST","host":"identity-staging.sproutportal.ca","path":"/u","mode":"passthrough"},{"binding":"IDENTITY","host":"identity-staging.sproutportal.ca","path":"/","mode":"passthrough"},{"binding":"SPROUT","host":"sprout-staging.sproutportal.ca","path":"/","mode":"passthrough"}]};
	ENVIRONMENT: string;
	IDENTITY_URL: string;
	BNC_ATT_KID: string;
	BNC_ATT_PRIV: string;
	GUESTLIST: Service<typeof import("../guestlist/src/index").default>;
	IDENTITY: Fetcher /* sprout-identity-production */ | Fetcher /* sprout-identity-staging */;
	SPROUT: Fetcher /* sprout-sprout-production */ | Fetcher /* sprout-sprout-staging */;
	MARKETING?: Fetcher /* sprout-marketing-production */;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ROUTES: {"routes":[{"binding":"GUESTLIST","host":"identity.sproutportal.ca","path":"/api","mode":"passthrough"},{"binding":"GUESTLIST","host":"identity.sproutportal.ca","path":"/u","mode":"passthrough"},{"binding":"IDENTITY","host":"identity.sproutportal.ca","path":"/","mode":"passthrough"},{"binding":"MARKETING","host":"sproutportal.ca","path":"/","mode":"passthrough"},{"binding":"MARKETING","host":"www.sproutportal.ca","path":"/","mode":"passthrough"},{"binding":"SPROUT","host":"sproutportal.ca","path":"/hub","mode":"passthrough"}]};
		ENVIRONMENT: string;
		IDENTITY_URL: string;
		BNC_ATT_KID: string;
		BNC_ATT_PRIV: string;
		GUESTLIST: Service<typeof import("../guestlist/src/index").default>;
		IDENTITY: Fetcher /* sprout-identity-production */;
		SPROUT: Fetcher /* sprout-sprout-production */;
		MARKETING: Fetcher /* sprout-marketing-production */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SPROUT_URL" | "ROUTES" | "ENVIRONMENT" | "IDENTITY_URL" | "BNC_ATT_KID" | "BNC_ATT_PRIV">> {}
}
